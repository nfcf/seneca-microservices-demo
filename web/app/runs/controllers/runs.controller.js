(function () {
    ...
    function RunsController($scope, $location, $mdDialog, $translate, Authentication, Users, Runs) {
        ...
        function activate() {
            $scope.$on('AUTH_TOKEN_UPDATED', function () {
            ...
            $scope.$watchGroup(['vm.query.filter.startDate',
                                ...
                                'vm.query.filter.endTime'], function (newValue, oldValue) {
                vm.refresh();
            });
        ...
        function setWelcomeMessages(currentWeeklyDistance) {
            ...
            if (userInfo != null) {
                ...
                vm.welcome.mood = currentWeeklyDistance < targetWeeklyDistance ? 'good' : 'bad';
            }
        }
